...
<head>
    ...
    <style>
        ...
        .leaflet-routing-container {
            max-height: 200px; /* Set the maximum height for the routing container */
...
<body>
    ...
    <script>
        ...
        L.Routing.control({
            waypoints: [
                L.latLng(-7.3300, 112.7650), // Titik C (Lokasi lain di Rungkut)
                L.latLng(-7.3367, 112.7661)  // Titik D (Universitas Pembangunan Nasional "Veteran" Jawa Timur)
            ],
            lineOptions: {
