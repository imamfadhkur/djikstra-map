...
<body>
  ...
  <script>
    var map = L.map('map').setView([-6.1751, 106.8650], 13); // Pusat peta di Jakarta
    ...
    var addressA = "jalan Medokan Asri Utara VI, Medokan Asri, Rungkut, Surabaya, Indonesia";
    var addressB = "Jalan Medokan Asri Timur V, Medokan Asri, Rungkut, Surabaya, Indonesia";

    // Mendapatkan koordinat untuk setiap alamat dan menambahkan rute ke peta
    getCoordinates(addressA, function(latLngA) {
      getCoordinates(addressB, function(latLngB) {
